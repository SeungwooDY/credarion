...
/**
 * Newest selectable/creatable month: December of NEXT year. Any past month
 * is fair game — teams reconcile historical months. Mirrors backend
 * can_create_period (app/periods.py) — the server enforces the bound; this
 * only decides what the calendar offers.
 */
