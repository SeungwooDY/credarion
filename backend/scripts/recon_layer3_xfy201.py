...
def main() -> None:
    ...
    try:
        ...
        for m in matches:
            ...
            # ADR-0001 amendment: discrepancy_type lives ONLY on the group's
            # primary row — don't let constituent rows (None) overwrite it.
            if m.discrepancy_type is not None or gk not in group_disc:
