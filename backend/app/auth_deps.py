...
def get_current_user(request: Request, db: Session = Depends(get_db)) -> User:
    ...
    # Stateless session revocation: the token carries a fingerprint of the
    # password hash it was issued against. A password change rotates the
    # fingerprint, invalidating every previously issued session.
